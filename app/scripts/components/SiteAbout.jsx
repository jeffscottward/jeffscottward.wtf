      	...
      	<div className="SiteAbout">
      		<div className="ui main text container">
				...
				<div className="about-body">
					<h3>User Interface Engineer, Creative Technologist, Decentralization Futurist.</h3>
					<p>Jeff is constantly thinking about the future. The Internet of Things. Ethereum. Bitcoin. Web 3.0. Full-stack Javascript. The world is moving ever faster towards the singularity and he hopes to be ready for it. </p>
